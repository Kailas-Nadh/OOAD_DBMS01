...
public class SecondHighestSponsorship {
	...
	public static double secondHighest(double sponsorshipAmount[]) {
	...
	public static void main(String[] args) {
		double sponsorshipAmount[] = SecondHighestSponsorship.inputValue();
		double secondHighest = SecondHighestSponsorship.secondHighest(sponsorshipAmount);
		System.out.println("The Second Highest Sponsorship Amount is " + secondHighest);
